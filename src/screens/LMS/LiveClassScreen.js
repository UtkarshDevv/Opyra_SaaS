...
const LiveClassScreen = ({ navigation, route }) => {
  ...
  const liveClass = {
    ...
    time: '14:00',
    duration: '60 min',
    description: 'Join us for an interactive Q&A session where we\'ll discuss React Native best practices, common challenges, and advanced topics. Bring your questions!',
    participants: 25,
    maxParticipants: 50,
    topics: [
    ...
    >
      ...
      <View style={styles.classStats}>
        ...
        <View style={styles.statItem}>
          ...
          <Text style={styles.statText}>{item.participants}/{item.maxParticipants}</Text>
        </View>
      </View>
    </TouchableOpacity>
  );
