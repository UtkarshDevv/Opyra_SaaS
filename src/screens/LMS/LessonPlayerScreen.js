...
const LessonPlayerScreen = ({ navigation, route }) => {
  ...
  const lesson = {
    ...
    description: 'In this lesson, we will explore the fundamentals of React Native, understand its architecture, and learn why it has become one of the most popular frameworks for mobile app development.',
    duration: '15 min',
    videoUrl: 'https://example.com/video.mp4', // Placeholder
    content: [
      {
        type: 'text',
        content: 'React Native is a JavaScript framework for building native mobile applications. It allows you to use React to build mobile apps that run on both iOS and Android platforms.'
      },
      {
        type: 'text',
        content: 'Key benefits of React Native include:\n• Cross-platform development\n• Hot reloading\n• Native performance\n• Large community support'
      },
      {
        type: 'text',
        content: 'In this course, you will learn how to set up your development environment, create your first React Native app, and understand the core concepts that make React Native powerful.'
      }
    ],
    resources: [
      { name: 'React Native Documentation', url: 'https://reactnative.dev' },
      { name: 'Getting Started Guide', url: 'https://reactnative.dev/docs/getting-started' },
